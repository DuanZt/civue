<template>
  <div class="db_detail">
      ...
      <div class="choice_style">
        ...
        <div class="choice_items">
          <span v-for="(item,index) in colors"
                :class="{active:index==isColors}"
                @click="isColors=index"
                :key="index">{{item}}</span>
        </div>
      </div>
      <div class="choice_style">
    ...
    <div class="db_detail_tabs">
      <span @click="toggleTabs('TabsDetail',$event)"
            data-id="0"
            :class="{active:0==isActive}">商品详情</span>
      <span @click="toggleTabs('TabsRated',$event)"
            data-id="1"
            :class="{active:1==isActive}">评价
        <i>2</i>
      </span>
      <span @click="toggleTabs('TabsDiscuss',$event)"
            data-id="2"
            :class="{active:2==isActive}">讨论</span>
    </div>
